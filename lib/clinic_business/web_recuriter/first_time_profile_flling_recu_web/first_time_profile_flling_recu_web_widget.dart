...
import 'first_time_profile_flling_recu_web_model.dart';
export 'first_time_profile_flling_recu_web_model.dart';

class FirstTimeProfileFllingRecuWebWidget extends StatefulWidget {
  const FirstTimeProfileFllingRecuWebWidget({super.key});

  static String routeName = 'firstTimeProfileFllingRecuWeb';
  static String routePath = '/firstTimeProfileFllingRecuWeb';

  @override
  State<FirstTimeProfileFllingRecuWebWidget> createState() =>
      _FirstTimeProfileFllingRecuWebWidgetState();
}

class _FirstTimeProfileFllingRecuWebWidgetState
    extends State<FirstTimeProfileFllingRecuWebWidget> {
  late FirstTimeProfileFllingRecuWebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FirstTimeProfileFllingRecuWebModel());
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              if (valueOrDefault(currentUserDocument?.subRole, '') == 'Individual') {
                                                                                _model.active = 2;
                                                                                safeSetState(() {});
                                                                              } else {
                                                                                _model.active = _model.active! + -1;
                                                                                        ...
                                                                                        Row(
                                                                                          ...
                                                                                          children: [
                                                                                            Theme(
                                                                                              ...
                                                                                              child: Checkbox(
                                                                                                value: _model.termsAndConditionsValue ??= false,
                                                                                                onChanged: (newValue) async {
                                                                                                  safeSetState(() => _model.termsAndConditionsValue = newValue!);
                                                                                                },
                                                                                                side: BorderSide(
                                                                                                  width: 2,
                                                                                          ...
                                                                                          child: Row(
                                                                                            ...
                                                                                            children: [
                                                                                              Theme(
                                                                                                ...
                                                                                                child: Checkbox(
                                                                                                  value: _model.consentForCheckValue ??= false,
                                                                                                  onChanged: (newValue) async {
                                                                                                    safeSetState(() => _model.consentForCheckValue = newValue!);
                                                                                                  },
                                                                                                  side: BorderSide(
                                                                                                    width: 2,
                                                                                                    color: FlutterFlowTheme.of(context).alternate,
                                                                                              ...
                                                                                              RichText(
                                                                                                ...
                                                                                                text: TextSpan(
                                                                                                  children: [
                                                                                                    TextSpan(
                                                                                                      text: 'Consent for Background Check &\n License Verification',
                                                                                                      style: GoogleFonts.getFont(
                                                                                                        'DM Sans',
                                                                                                        color: Color(0xFF89969F),
                                                                                                        fontWeight: FontWeight.w500,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              if (_model.termsAndConditionsValue! && _model.consentForCheckValue!) {
                                                                                ...
                                                                                context.goNamed(DashboardRecuriterWebWidget.routeName);
                                                                              }
                                                                            },
                                                                            text:
                                                                                'Save',
