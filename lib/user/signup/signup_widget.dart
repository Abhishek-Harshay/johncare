                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (valueOrDefault(
                                          ...
                                          _model.provider = ProviderDetailRecord
                                              .getDocumentFromData(
                                                  createProviderDetailRecordData(
                                                    user: currentUserReference,
                                                  ),
                                          ...
                                          _model.business = BusinessdetailRecord
                                              .getDocumentFromData(
                                                  createBusinessdetailRecordData(
                                                    users: currentUserReference,
                                                  ),
                                          ...
                                          if (isWeb) {
                                            context.goNamedAuth(
                                                FirstTimeProfileFllingRecuWebWidget
                                                    .routeName,
                                                context.mounted);
                                          } else {
                                            context.goNamedAuth(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (valueOrDefault(
                                          ...
                                          if (valueOrDefault(
                                            ...
                                            _model.providerGoogle = ProviderDetailRecord
                                                .getDocumentFromData(
                                                    createProviderDetailRecordData(
                                                      user:
                                            ...
                                            _model.businessGoogle = BusinessdetailRecord
                                                .getDocumentFromData(
                                                    createBusinessdetailRecordData(
                                                      users:
                                                          currentUserReference,
