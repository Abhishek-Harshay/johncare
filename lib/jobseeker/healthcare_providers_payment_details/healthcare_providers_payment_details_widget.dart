...
import 'healthcare_providers_payment_details_model.dart';
export 'healthcare_providers_payment_details_model.dart';

class HealthcareProvidersPaymentDetailsWidget extends StatefulWidget {
  const HealthcareProvidersPaymentDetailsWidget({super.key});

  static String routeName = 'HealthcareProvidersPaymentDetails';
  static String routePath = '/healthcareProvidersPaymentDetails';

  @override
  State<HealthcareProvidersPaymentDetailsWidget> createState() =>
      _HealthcareProvidersPaymentDetailsWidgetState();
}

class _HealthcareProvidersPaymentDetailsWidgetState
    extends State<HealthcareProvidersPaymentDetailsWidget> {
  late HealthcareProvidersPaymentDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => HealthcareProvidersPaymentDetailsModel());
