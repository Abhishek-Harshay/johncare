...
import 'admin_home_for_user_model.dart';
export 'admin_home_for_user_model.dart';

class AdminHomeForUserWidget extends StatefulWidget {
  const AdminHomeForUserWidget({super.key});

  static String routeName = 'adminHomeForUser';
  static String routePath = '/adminHomeForUser';

  @override
  State<AdminHomeForUserWidget> createState() => _AdminHomeForUserWidgetState();
}

class _AdminHomeForUserWidgetState extends State<AdminHomeForUserWidget>
    with TickerProviderStateMixin {
  late AdminHomeForUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminHomeForUserModel());
                                                      ...
                                                      builder: (context) {
                                                        ...
                                                        return FlutterFlowDataTable<
                                                          ...
                                                          dataRowBuilder:
                                                            ...
                                                            cells: [
                                                              Text(
                                                                '${workerDetailsItem.firstName}${workerDetailsItem.lastName}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                          ...
                                                          child: Builder(
                                                            builder: (context) {
                                                              ...
                                                              return FlutterFlowDataTable<
                                                                ...
                                                                dataRowBuilder: (jobDetails4Item,
                                                                        jobDetails4Index,
                                                                        selected,
                                                                        onSelectChanged) =>
                                                                    DataRow(
                                                          ...
                                                          child: Builder(
                                                            builder: (context) {
                                                              ...
                                                              return FlutterFlowDataTable<
                                                                ...
                                                                dataRowBuilder: (jobDetails5Item,
                                                                        jobDetails5Index,
                                                                        selected,
                                                                        onSelectChanged) =>
                                                                    DataRow(
