...
import 'admin_job_management_active_post_details_model.dart';
export 'admin_job_management_active_post_details_model.dart';

class AdminJobManagementActivePostDetailsWidget extends StatefulWidget {
  const AdminJobManagementActivePostDetailsWidget({super.key});

  static String routeName = 'AdminJobManagementActivePostDetails';
  static String routePath = '/adminJobManagementActivePostDetails';

  @override
  State<AdminJobManagementActivePostDetailsWidget> createState() =>
      _AdminJobManagementActivePostDetailsWidgetState();
}

class _AdminJobManagementActivePostDetailsWidgetState
    extends State<AdminJobManagementActivePostDetailsWidget> {
  late AdminJobManagementActivePostDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => AdminJobManagementActivePostDetailsModel());
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    'We are currently seeking a Registered Nurse to join our \ndynamic healthcare team. As a Registered Nurse, you will \nplay a crucial role in providing high-quality patient...',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    'Valid Nursing License: Must hold a current and unrestricted\nRegistered Nurse (RN) or Licensed Practical Nurse (LPN)',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
