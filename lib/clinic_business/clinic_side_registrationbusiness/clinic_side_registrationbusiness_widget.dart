...
import 'clinic_side_registrationbusiness_model.dart';
export 'clinic_side_registrationbusiness_model.dart';

class ClinicSideRegistrationbusinessWidget extends StatefulWidget {
  const ClinicSideRegistrationbusinessWidget({super.key});

  static String routeName = 'ClinicSideRegistrationbusiness';
  static String routePath = '/clinicSideRegistrationbusiness';

  @override
  State<ClinicSideRegistrationbusinessWidget> createState() =>
      _ClinicSideRegistrationbusinessWidgetState();
}

class _ClinicSideRegistrationbusinessWidgetState
    extends State<ClinicSideRegistrationbusinessWidget> {
  late ClinicSideRegistrationbusinessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClinicSideRegistrationbusinessModel());

    _model.businessClinicname19TextController ??= TextEditingController();
    _model.businessClinicname19FocusNode ??= FocusNode();

    _model.businessregistrationnumber19TextController ??=
    ...
    _model.positionTitle19TextController ??= TextEditingController();
    ...
    _model.expectedfrequencyofuse19TextController ??= TextEditingController();
    _model.expectedfrequencyofuse19FocusNode ??= FocusNode();

    _model.taxIDorGSTNo19TextController ??= TextEditingController();
    _model.taxIDorGSTNo19FocusNode ??= FocusNode();

    _model.buisnessID19TextController ??= TextEditingController();
                                                  ...
                                                  await currentUserDocument!
                                                    ...
                                                    businessInformation:
                                                      ...
                                                      businessName: _model
                                                          .businessClinicname19TextController
                                                          .text,
                                                      typeofBusiness: _model
                                                          .typeofBusiness19Value,
                                                      businessregistrationnumber:
                                                          _model
                                                              .businessregistrationnumber19TextController
                                                              .text,
                                                      numbersOfLocations: _model
                                                          .noOfLocation19Value,
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode:
                                              _model.positionTitle19FocusNode,
                                          autofocus: true,
                                          autofillHints: [AutofillHints.email],
                                          obscureText: false,
                                          decoration: InputDecoration(
