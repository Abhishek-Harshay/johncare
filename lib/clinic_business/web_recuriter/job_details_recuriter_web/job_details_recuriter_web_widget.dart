...
import 'job_details_recuriter_web_model.dart';
export 'job_details_recuriter_web_model.dart';

class JobDetailsRecuriterWebWidget extends StatefulWidget {
  const JobDetailsRecuriterWebWidget({
    super.key,
    this.job,
  });
  ...
  static String routeName = 'JobDetailsRecuriterWeb';
  static String routePath = '/jobDetailsRecuriterWeb';

  @override
  State<JobDetailsRecuriterWebWidget> createState() =>
      _JobDetailsRecuriterWebWidgetState();
}

class _JobDetailsRecuriterWebWidgetState
    extends State<JobDetailsRecuriterWebWidget> {
  late JobDetailsRecuriterWebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobDetailsRecuriterWebModel());
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<JobDetailsRecord>(
                stream: JobDetailsRecord.getDocument(widget.job!.reference),
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Builder(
                                                                builder:
                                                                    (context) {
                                                                  final attendance = columnJobDetailsRecord
                                                                      .attendanceJob
                                                                      .where((e) =>
                                                                          e.isSendRequest)
                                                                      .toList();
                                                                                          ...
                                                                                          ...mapToFirestore(
                                                                                            {
                                                                                              'AttendanceJob': getAttendanceListFirestoreData(
                                                                                                functions.updateAttendce(attendanceIndex, columnJobDetailsRecord.attendanceJob.toList(), false),
                                                                                              ),
                                                                                            },
                                                                                          ),
                                                                                        });
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Builder(
                                                          builder: (context) {
                                                            final applicant = containerAppliedJobRecordList
                                                                .where((e) =>
                                                                    e.appliedJobStatus !=
                                                                    'Reject')
                                                                .toList()
                                                                                                                ...
                                                                                                                child: CancelBookingWidget(
                                                                                                                  jobAction: () async {
                                                                                                                    ...
                                                                                                                    triggerPushNotification(
                                                                                                                      ...
                                                                                                                      userRefs: [containerProviderDetailRecord.user!],
