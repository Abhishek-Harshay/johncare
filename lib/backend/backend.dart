...
import 'schema/job_details_record.dart';
import 'schema/provider_detail_record.dart';
import 'schema/location_record.dart';
import 'schema/businessdetail_record.dart';
import 'schema/applicant_record.dart';
...
export 'schema/job_details_record.dart';
export 'schema/provider_detail_record.dart';
export 'schema/location_record.dart';
export 'schema/businessdetail_record.dart';
export 'schema/applicant_record.dart';
...
/// Functions to query JobDetailsRecords (as a Stream and as a Future).
Future<int> queryJobDetailsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<JobDetailsRecord>> queryJobDetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      JobDetailsRecord.collection,
      JobDetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<JobDetailsRecord>> queryJobDetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ProviderDetailRecords (as a Stream and as a Future).
Future<int> queryProviderDetailRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ProviderDetailRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ProviderDetailRecord>> queryProviderDetailRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ProviderDetailRecord.collection,
      ProviderDetailRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ProviderDetailRecord>> queryProviderDetailRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query BusinessdetailRecords (as a Stream and as a Future).
Future<int> queryBusinessdetailRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BusinessdetailRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BusinessdetailRecord>> queryBusinessdetailRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BusinessdetailRecord.collection,
      BusinessdetailRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BusinessdetailRecord>> queryBusinessdetailRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ApplicantRecords (as a Stream and as a Future).
Future<int> queryApplicantRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ApplicantRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ApplicantRecord>> queryApplicantRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ApplicantRecord.collection,
      ApplicantRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ApplicantRecord>> queryApplicantRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
